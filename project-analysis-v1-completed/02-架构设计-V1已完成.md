...
**说明**：**Policy / 规则**、**审批中心**、**Capability Routing**、**Audit** 管理面均已产品化（2026-06）；Task、Skill 管理 UI 仍为实验中。
...
| §4.2 平台服务层 | ✅ 核心模块已落地；**Capability Routing / Policy / Approval** 已产品化；Task/Skill 管理 UI 实验中 |
