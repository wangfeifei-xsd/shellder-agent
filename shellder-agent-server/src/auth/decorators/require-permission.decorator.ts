...
export const REQUIRE_ANY_MENU_KEY = 'requireAnyMenu';
export const REQUIRE_MODULE_KEY = 'requireModule';

/** 要求拥有指定菜单权限，否则 403（验收标准 2） */
export const RequireMenu = (menu: MenuKey) => SetMetadata(REQUIRE_MENU_KEY, menu);

/** 要求拥有任一指定菜单权限，否则 403（共用 API 场景） */
export const RequireAnyMenu = (...menus: MenuKey[]) =>
  SetMetadata(REQUIRE_ANY_MENU_KEY, menus);
